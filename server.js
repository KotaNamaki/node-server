...
app.use(cors({
    origin: ['http://localhost', 'http://127.0.0.1:5500', 'https://motodiv.store', 'https://admin.motodiv.store', 'null', 'https://api.motodiv.store', 'http://localhost:3000'], // 'null' untuk file lokal
